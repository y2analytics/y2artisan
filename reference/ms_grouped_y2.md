...
grouped variable. It requires two lists called "text_settings_grouped"
...
- overlapping:
  ...
  DEFAULT = -50 This leaves 50% extra space between variable levels. Set
  to 100 when coloring bars different colors.
...
chart <- ms_grouped_y2()
#> Error in ms_grouped_y2(): object 'frequencies' not found
