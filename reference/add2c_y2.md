...
This function adds 2 charts/tables/other objects to a PowerPoint slide.
...
``` r
add2c_y2(name, position, label_first_only = FALSE)
```
...
- position:
  ...
  Position options: "top"; "bottom"; "left"; "right". The chart layout
  can either be top-bottom OR left-right.
